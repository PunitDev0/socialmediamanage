...
const OverviewMetrics = ({ isMounted }) => {
  ...
  const metrics = [
    { platform: 'f', value: 1322, change: '-4.5%', trend: [1300, 1350, 1320, 1310, 1330, 1325, 1322] },
    { platform: 'ig', value: 4134, change: '-2.1%', trend: [4200, 4180, 4160, 4150, 4140, 4135, 4134] },
    { platform: 'yt', value: 501, change: '-3.3%', trend: [520, 515, 510, 505, 503, 502, 501] },
    { platform: 'in', value: 1013, change: '-1.8%', trend: [1030, 1025, 1020, 1018, 1015, 1014, 1013] },
    { platform: 'p', value: 322, change: '-5.0%', trend: [340, 335, 330, 328, 325, 323, 322] },
    { platform: 't', value: 981, change: '+2.7%', trend: [950, 960, 970, 975, 978, 980, 981] },
  ];
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
      {metrics.map((metric, index) => (
        ...
        >
          <Card className="rounded-2xl shadow-md border-none min-h-[220px] bg-white hover:shadow-lg transition-all duration-300">
            <CardContent className="flex flex-col items-center justify-between pt-6 space-y-4 h-full">
              <div className="flex flex-col items-center space-y-2">
                ...
                <div className="text-center">
                  ...
                  <p className={`text-sm font-medium ${metric.change.startsWith('+') ? 'text-green-500' : 'text-red-500'}`}>
                    {metric.change}
                  </p>
                </div>
              </div>
              ...
              >
                <Line data={getChartData(metric.trend)} options={chartOptions} />
              </motion.div>
            </CardContent>
          </Card>
        </motion.div>
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      tooltip: {
        ...
        bodyFont: { size: 12 },
        callbacks: {
          label: (context) => `${context.raw} engagements`,
        },
      },
    },
    scales: {
