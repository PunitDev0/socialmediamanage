...
import InstagramPostEditor from "./InstagramPostEditor";
import InstagramPostPreview from "./InstagramPostPreview";
import InstagramPostSettings from "./InstagramPostSettings";
...
export default function CreateInstagramPostPage() {
  ...
  const schedulePost = async (data) => {
    ...
    formData.append("disableComments", data.disableComments);
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/post/instagram/schedule",
        formData,
        {
      ...
      if (response.data.success) {
        ...
        setValue("time", "12:00");
        setValue("location", "");
        setValue("disableComments", false);
        setValue("altText", "");
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold tracking-tight">Instagram Post ya Reels Schedule Karein</h1>
        <p className="text-muted-foreground">Apna Instagram Feed post ya Reels banayein aur schedule karein</p>
      </div>
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <InstagramPostPreview watch={watch} selectedMedia={selectedMedia} postType={postType} />
