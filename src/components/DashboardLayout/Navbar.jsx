...
import { Inbox, Home, BarChart3, Calendar, LayoutDashboard, PenSquare, Settings } from "lucide-react";
...
export default function Navbar({ toggleSidebar, isMobile }) {
  ...
  const navItems = [
    ...
    { name: "Scheduled Posts", href: "/dashboard/scheduled-posts", icon: Calendar },
    { name: "Analytics", href: "/dashboard/analytics", icon: BarChart3 },
    { name: "Settings", href: "/dashboard/settings", icon: Settings },
  ];

  return (
    <header className=" top-0  right-0 h-16 bg-card border-b z-30 fixed backdrop-blur-2xl right">
